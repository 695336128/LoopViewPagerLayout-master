...
public class EmptyLoopViewPagerFragment extends BaseFragment implements OnBannerItemClickListener {
    ...
    protected void initData() {
        ...
        mLoopViewPagerLayout.getLoopViewPager().setOffscreenPageLimit(3);
        mLoopViewPagerLayout.getLoopViewPager().addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            @Override
